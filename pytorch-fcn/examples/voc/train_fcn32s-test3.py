...
def get_parameters(model, bias=False):
    ...
    modules_skipped = (
        ...
        nn.Dropout2d,
        nn.Sequential,
        torchfcn.models.FCN32s_wo_crop,
...
def main():
    ...
    out = get_log_dir('fcn32s_wo_crop', args.config, cfg)
    resume = args.resume
    ...
    model = torchfcn.models.FCN32s_wo_crop(n_class=7)
    ...
    trainer = torchfcn.Trainer_wo_crop(
        cuda=cuda,
        model=model,
        optimizer=optim,
