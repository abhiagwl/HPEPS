...
def main():
    ...
    out = get_log_dir('combined-fcn-paf-full-sgd-vallog-classes', args.config, cfg)
    resume = args.resume
    ...
    train_loader = torch.utils.data.DataLoader(
        torchfcn.datasets.Combined_test(root, split='train', transform=True,test_par = 1.0),
    ...
    trainer = torchfcn.TrainerCOM_sgd(
        cuda=cuda,
        model=model,        
        optimizer=optim,
        scheduler=scheduler,
