...
class PAF_MULT(nn.Module):
    ...
    def __init__(self, n_pose=14,n_paf=26):
        super(PAF_MULT, self).__init__()
        # conv1
        ...
        self.poseconv5 = nn.Conv2d(512, n_pose, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.pafconv5 = nn.Conv2d(512, n_paf, kernel_size=(1, 1), stride=(1, 1))


        #pose st2
        
        self.poseconv1_st2 = nn.Conv2d(512+n_pose+n_paf, 128, kernel_size=(7, 7), stride=(1, 1), padding=(3, 3))
        ...
        self.poseconv7_st2 = nn.Conv2d(512, n_pose, kernel_size=(1, 1), stride=(1, 1))

        #paf st2
        self.pafconv1_st2 = nn.Conv2d(512+n_pose+n_paf, 128, kernel_size=(7, 7), stride=(1, 1), padding=(3, 3))
        ...
        self.pafconv7_st2 = nn.Conv2d(512, n_paf, kernel_size=(1, 1), stride=(1, 1))
