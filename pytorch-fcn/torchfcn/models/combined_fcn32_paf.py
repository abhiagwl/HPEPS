...
"""------------------------------MODEL FOR COMBINED PAF AND FCN ------------------------------"""
"""------------------------------MODEL FOR COMBINED PAF AND FCN ------------------------------"""
"""------------------------------MODEL FOR COMBINED PAF AND FCN ------------------------------"""
"""------------------------------MODEL FOR COMBINED PAF AND FCN ------------------------------"""
"""------------------------------MODEL FOR COMBINED PAF AND FCN ------------------------------"""
...
class COMB_FCN_PAF(nn.Module):
    ...
    def __init__(self, n_seg_class=7,n_pos_class = 14,n_paf_class = 26):
        super(COMB_FCN_PAF, self).__init__()
        # conv1
    ...
    def forward(self, x):
        ...
        h_ = self.relu4_3(self.conv4_3(h))
        h = self.pool4(h_)

        pose = self.poserelu1(self.poseconv1(h_))
        ...
        paf = self.pafrelu1(self.pafconv1(h_))
